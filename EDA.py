# -*- coding: utf-8 -*-
"""
Created on Fri Mar 21 09:19:11 2025
...
# Load the dataset
S0 = pd.read_csv("D:/TEACHING/2024 teaching academic research/R/programs/datasets/SalesDatafor preprocessing(maneet kaur).csv"  )
S0
...
S0["Unit Price"].fillna(np.random.uniform(S0["Unit Price"].min(), S0["Unit Price"].max()), 
                        inplace=True)  
...
S0["Ship Mode"].fillna(S0["Ship Mode"].mode()[0], inplace=True)  
